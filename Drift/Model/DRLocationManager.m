...
- (void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations {
    ...
    if (newLocation.timestamp.timeIntervalSinceNow > -20 && newLocation.horizontalAccuracy <= [[DRVariableManager sharedManager] GPSOneBarThresh]) { //not older than 20 seconds and more accurate than 50m
